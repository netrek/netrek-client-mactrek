...
@interface LLThreadWorker (PrivateAPI)
                   ...
                   didEndSelector:(SEL)didEndSelector;  // Optional
{
    ...
    // Create an instance of LLThreadWorker
    tw = [[[LLThreadWorker alloc] 
...
-(void)runPrimaryTask:(id)notUsed
{
    ...
    // Call user's selector with this LLThreadWorker as
...
{   return @"LLThreadWorker v0.7. Public Domain. Original author: Robert Harder, rob@iharder.net. Keep up-to-date at http://iHarder.net";
}   // end description
