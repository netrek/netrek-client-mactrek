...
+ (LLTrigonometry*) defaultInstance {
    ...
    if (defaultInstance == nil) {
        defaultInstance = [[LLTrigonometry alloc] init];
    }
 ...
 */
- (int)hypotOfBase:(int) x1 heigth:(int)y1 {
...
- (float)angleDegBetween:(NSPoint)p1 andPoint:(NSPoint)p2 {
    ...
    //return rint((atan2 (deltaY, deltaX)) / pi * 128);
    // hmm this is in rad 2pi makes 360 so...
    return (atan2f (deltaY, deltaX)) / pi * 180;
}
