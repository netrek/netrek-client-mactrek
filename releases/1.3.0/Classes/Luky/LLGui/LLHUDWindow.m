...
- (void)addCloseWidget
{
    ...
    NSString *pathToImage = [NSString stringWithFormat:@"%@/LLResources/hud_titlebar-close.tiff", pathToResources];
    NSImage *rawImage = [[[NSImage alloc] initWithContentsOfFile:pathToImage] autorelease];
	[closeButton setImage:rawImage];
